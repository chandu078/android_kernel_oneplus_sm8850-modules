...
static struct cam_camnoc_info cam640_cpas210_camnoc_info = {
	...
	.niu = &cam_cpas_v640_210_camnoc_niu[0],
	.num_nius = ARRAY_SIZE(cam_cpas_v640_210_camnoc_niu),
...
static struct cam_tpg_mux_regs cam640_cpas210_cpas_tpg_mux_info = {
	.tpg_mux_sel_enabled = true,
	.tpg_mux_sel_shift   = 0x0,
	.tpg_mux_sel         = 0x1C,
};

static struct cam_cpas_subpart_info cam640_cpas210_camera_subpart_info = {
	.num_bits = 2,
	/*
...
static struct cam_cpas_info cam640_cpas210_cpas_info = {
	...
	.num_qchannel = 1,
	.tpg_mux_info = &cam640_cpas210_cpas_tpg_mux_info,
	.camera_arch = CAM_CPAS_HW_MIMAS_ARCH,
	.subpart_info = &cam640_cpas210_camera_subpart_info,
};

static struct cam_cpas_hw_info cam640_cpas210_hw_info = {
	.hw_info_version                     = CAM_CPAS_HW_INFO_VER1,
	.camnoc_info[CAM_CAMNOC_HW_COMBINED] = &cam640_cpas210_camnoc_info,
