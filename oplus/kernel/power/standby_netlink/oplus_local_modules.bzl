...
load("//vendor/qcom/sm8850-modules/oplus/bazel:oplus_modules_define.bzl", "define_oplus_ddk_module", "oplus_ddk_get_variant", "oplus_ddk_get_target", "bazel_support_platform")
